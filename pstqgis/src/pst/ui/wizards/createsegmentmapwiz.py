...
class TrimmingPage(BasePage):
	...
	def createWidgets(self):
		...
		self._snapEdit.setAlignment(Qt.AlignmentFlag.AlignRight)
		...
		self._tailEdit.setAlignment(Qt.AlignmentFlag.AlignRight)
		...
		self._mergeEdit.setAlignment(Qt.AlignmentFlag.AlignRight)
